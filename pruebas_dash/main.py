...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        options=[
            {'label': 'High vacuum test', 'value': 't1'},
            {'label': 'Capacity and Internal Resistance vs Temperature', 'value': 't2'},
            {'label': 'Self-Discharge', 'value': 't3'},
            {'label': 'LEO Cycling', 'value': 't4'},
            {'label': 'LEO Cycling', 'value': 't5'},
            {'label': 'Reduced pressure 30 % DOD Cycling', 'value': 't6'},
            {'label': 'Reduced pressure 80% DOD Cycling', 'value': 't7'}
